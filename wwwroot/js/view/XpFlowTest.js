var _me = {
    ...
    init: function () {        
            ...
            columnDefs: [
				{ targets: [4], render: function (data, type, full, meta) {
                    return (full.CanSign == 1)
                        ? _str.format('<button type="button" class="btn btn-outline-secondary btn-sm" onclick="_crud.onUpdate(\'{0}\')">審核</button>', full.Id)
                        : '';
                }},
				...
				{ targets: [6], render: function (data, type, full, meta) {
                    return _crud.dtCrudFun(full.Id, 'Leave', false, false, true);
                }},
            ],
        };
        ...
        _crud.init(config, [_me.edit0], '審核');
